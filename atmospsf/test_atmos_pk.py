...
#   P(k) = 2pi \int theta dtheta J_0(k theta) xi_+(theta).
...
amp = 1.e-4
print "To PS, 1"
p1 = corrfunc_to_ps(amp, 100., test_k, 2.5*theta_arcsec)
print "To PS, 2"
p2 = corrfunc_to_ps(amp, 1000., test_k, 2.5*theta_arcsec)
print "To PS, 3"
p3 = corrfunc_to_ps(amp, 3000., test_k, 4*theta_arcsec)
print "Plotting"
fig = plt.figure()
...
ax.plot((ell_20, ell_20), (1.e-4,1.e5), label='ell=20')
ax.plot((ell_2000, ell_2000), (1.e-4,1.e5), label='ell=2000')
ax.set_xscale('log')
ax.set_yscale('log')
