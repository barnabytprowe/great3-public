...
c.execute("alter table leaderboard_entry add column 'm_minus' 'float' NOT NULL default 1.0")
c.execute("alter table leaderboard_entry add column 'c_minus' 'float' NOT NULL default 1.0")
c.execute("alter table leaderboard_entry add column 'delta_m_plus' 'float' NOT NULL default 1.0")
c.execute("alter table leaderboard_entry add column 'delta_m_minus' 'float' NOT NULL default 1.0")
c.execute("alter table leaderboard_entry add column 'delta_c_plus' 'float' NOT NULL default 1.0")
c.execute("alter table leaderboard_entry add column 'delta_c_minus' 'float' NOT NULL default 1.0")
