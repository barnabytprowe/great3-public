...
c = con.cursor()
c.execute("alter table leaderboard_board add column 'frozen' 'bool' NOT NULL default True")
c.execute("alter table leaderboard_board add column 'blind' 'bool' NOT NULL  default True")
...
c.execute("alter table leaderboard_entry add column 'blind' 'bool' NOT NULL default True")
