...
try:
    from secret_settings import SECRET_KEY, EMAIL_HOST, EMAIL_PORT, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, EMAIL_USE_TLS
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(installation_base,'data','great3.sqlite3'),                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(installation_base,'collected_static')
...
STATICFILES_DIRS = (
    ...
    os.path.join(installation_base, 'static'),
...
ROOT_URLCONF = 'great3.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'great3.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(installation_base, 'templates')
)
INSTALLED_APPS = (
    'django.contrib.auth',
...
AXES_LOCKOUT_TEMPLATE='axes-custom/lockout.html'
