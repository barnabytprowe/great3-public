...
ax.plot(subell,fitp1,color='blue',linestyle='dashed',label='(best power law)')
ax.plot(ell,p2,color='red',label='zmed=1.00')
ax.plot(subell,fitp2,color='red',linestyle='dashed',label='(best power law)')
ax.plot(ell,p3,color='green',label='zmed=1.25')
ax.plot(subell,fitp3,color='green',linestyle='dashed',label='(best power law)')
ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('ell')
ax.set_ylabel('P')
