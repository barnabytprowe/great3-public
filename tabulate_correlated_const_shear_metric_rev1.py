...
if __name__ == "__main__":
    ...
    coutfile = os.path.join("results", "tabulated_correlated_const_Q_c_versus_c_norm2.pkl")
    moutfile = os.path.join("results", "tabulated_correlated_const_Q_c_versus_m_norm2.pkl")
